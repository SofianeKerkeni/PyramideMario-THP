...
number_mail.times do |i|
    ...
    arrayMail.push(adresseMail + (i).to_s + extension)
end

#affiche les nombres pair selectionner itinerais par l'index pair du tableau
puts arrayMail.select.each_with_index { |item , index| index.even? }